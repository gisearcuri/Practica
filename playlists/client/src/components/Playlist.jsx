...
const Playlist = ({listaPlaylists, setListaPlaylists}) => {
    ...
    return(
        <div>
            ...
            <button type="submit" className="btn btn-primary" onClick={borrar}>Eliminar</button> || <button type="submit" className="btn btn-primary" onClick={updatePlaylist}>Editar</button> 
        </div>
    )
